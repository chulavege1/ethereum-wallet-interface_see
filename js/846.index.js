/*! For license information please see 846.index.js.LICENSE.txt */
  ...
  [846],
  {
      ...
      function s() {
        ...
        function f(t, e, n, r) {
          var s = e && e.prototype instanceof g ? e : g,
            ...
            a = new T(r || []);
          return o(i, "_invoke", { value: k(t, n, a) }), i;
        }
        function d(t, e, n) {
          try {
        ...
        function N(t, e) {
          ...
          var s = d(r, t.iterator, e.arg);
          if ("throw" === s.type)
            return (
              (e.method = "throw"), (e.arg = s.arg), (e.delegate = null), p
            );
          var i = s.arg;
          return i
            ? i.done
        ...
        return (
          ...
          E(P.prototype),
          h(P.prototype, u, function () {
            return this;
          }),
          (e.AsyncIterator = P),
          (e.async = function (t, n, r, s, i) {
            void 0 === i && (i = Promise);
            var o = new P(f(t, n, r, s), i);
    ...
    274: (t, e, n) => {
      ...
      class c extends s.XI {
        ...
        encode(t, e) {
          let n = a._.dereference(e, "string");
          try {
            n = (0, i.K)(n);
          } catch (t) {
        ...
        decode(t) {
          return (0, i.K)((0, o.m9)(t.readValue(), 20));
        }
      }
      var u = n(5857);
      ...
      class d extends s.XI {
        ...
        encode(t, e) {
          const n = a._.dereference(e, "array");
      ...
      class p extends s.XI {
        ...
        encode(t, e) {
          const n = a._.dereference(e, "bool");
      ...
      class w extends s.XI {
        ...
        encode(t, e) {
          let n = (0, g.h_)(a._.dereference(e, this.type));
          return (
            n.length !== this.size &&
      ...
      class k extends s.XI {
        ...
        encode(t, e) {
          let n = (0, o.yT)(a._.dereference(e, this.type)),
            r = (0, o.sS)(P, 8 * s.Bx);
          if (this.signed) {
            let t = (0, o.sS)(r, 8 * this.size - 1);
            (n > t || n < -(t + E)) &&
              this._throwError("value out-of-bounds", e),
              (n = (0, o.$j)(n, 8 * s.Bx));
          } else
            (n < v || n > (0, o.sS)(r, 8 * this.size)) &&
              this._throwError("value out-of-bounds", e);
          return t.writeValue(n);
        }
        decode(t) {
          let e = (0, o.sS)(t.readValue(), 8 * this.size);
          return this.signed && (e = (0, o._Y)(e, 8 * this.size)), e;
        }
      }
      var N = n(7155);
      class x extends m {
        ...
        encode(t, e) {
          return super.encode(t, (0, N.Y0)(a._.dereference(e, "string")));
        }
        decode(t) {
      ...
      class C extends s.XI {
        ...
        encode(t, e) {
          const n = a._.dereference(e, "tuple");
      ...
      class B {
        ...
        getDefaultValue(t) {
          const e = t.map((t) => this.#t(T._R.from(t)));
          return new C(e, "_").defaultValue();
        }
        encode(t, e) {
          (0, r.fG)(e.length, t.length, "types/values length mismatch");
          const n = t.map((t) => this.#t(T._R.from(t))),
            i = new C(n, "_"),
            o = new s.QV();
          return i.encode(o, e), o.data;
        }
        decode(t, e, n) {
          const r = t.map((t) => this.#t(T._R.from(t)));
          return new C(r, "_").decode(new s.Ej(e, n));
        }
              ...
              if (((n = (0, g.Dv)(n)), 0 === t.length))
                ...
                try {
                  ...
                  (c = {
                    ...
                    (a = `Panic due to ${I.get(e) || "UNKNOWN"}(${e})`),
                    (o += `: ${a}`);
                } catch (t) {
    ...
    8135: (t, e, n) => {
        ...
        constructor(...t) {
          ...
          if (
            ((this.#e = Object.freeze(
              n.map((t, e) => {
                const n = s[e];
                return null != n && 1 === o.get(n) ? n : null;
              }),
            )),
            i)
          )
      ...
      function p(t) {
        let e = (0, r.ot)(t);
        return (
          (0, s.hu)(e.length <= a, "value out-of-bounds", "BUFFER_OVERRUN", {
            buffer: e,
            length: a,
            offset: e.length,
          }),
          e.length !== a &&
            (e = (0, i.h_)((0, i.zo)([c.slice(e.length % a), e]))),
          e
        );
      }
      class g {
      ...
      class y {
        ...
        readValue() {
          return (0, r.Gh)(this.readBytes(a));
        }
        readIndex() {
          return (0, r.He)(this.readBytes(a));
        }
      }
    },
    6052: (t, e, n) => {
      ...
      const c = "constant external internal payable private public pure view",
        ...
        d = a(f.split(" ")),
        p = a([l, f, "tuple returns", c].join(" ").split(" ")),
        g = {
          "(": "OPEN_PAREN",
          ")": "CLOSE_PAREN",
          "[": "OPEN_BRACKET",
      ...
      function E(t) {
        const e = [],
          n = (e) => {
            const n = o < t.length ? JSON.stringify(t[o]) : "$EOI";
            throw new Error(`invalid token ${n} at ${o}: ${e}`);
          };
        let s = [],
          i = [],
          o = 0;
        for (; o < t.length; ) {
          let a = t.substring(o),
            c = a.match(m);
          c && ((o += c[1].length), (a = t.substring(o)));
          const u = {
            depth: s.length,
            linkBack: -1,
            linkNext: -1,
          ...
          let l = g[a[0]] || "";
          if (l) {
            if (((u.type = l), (u.text = a[0]), o++, "OPEN_PAREN" === l))
          ...
          } else if (((c = a.match(w)), c)) {
            if (((u.text = c[1]), (o += u.text.length), p.has(u.text))) {
              u.type = "KEYWORD";
              continue;
            }
            if (u.text.match(b)) {
            ...
            if (((c = a.match(y)), !c))
              throw new Error(
                `unexpected token ${JSON.stringify(a[0])} at position ${o}`,
              );
            (u.text = c[1]), (u.type = "NUMBER"), (o += u.text.length);
          }
        }
      ...
      function x(t) {
        let e = N(t, u);
        return (
          P(e, a("constant payable nonpayable".split(" "))),
          P(e, a("pure view payable nonpayable".split(" "))),
          e.has("view")
            ? "view"
            : e.has("pure")
            ? "pure"
      ...
      function C(t, e) {
        return t.popParams().map((t) => K.from(t, e));
      }
      function T(t) {
        if (t.peekType("AT")) {
      ...
      class K {
        ...
        static from(t, e) {
          if (K.isParamType(t)) return t;
          if ("string" == typeof t) return K.from(E(t), e);
          if (t instanceof v) {
            let n = "",
              r = "",
              s = null;
            N(t, a(["tuple"])).has("tuple") || t.peekType("OPEN_PAREN")
              ? ((r = "tuple"),
                (s = t.popParams().map((t) => K.from(t))),
          ...
          if (o) {
            const e = parseInt(o[2] || "-1"),
              s = K.from({ type: o[1], components: t.components });
            return new K(S, n || "", i, "array", r, null, e, s);
          }
          if ("tuple" === i || i.startsWith("tuple(") || i.startsWith("(")) {
            const e =
              null != t.components ? t.components.map((t) => K.from(t)) : null;
            return new K(S, n || "", i, "tuple", r, e, null, null);
          }
          return (i = O(t.type)), new K(S, n || "", i, i, r, null, null, null);
        }
      ...
      class Q extends H {
        ...
        get selector() {
          return (0, o.id)(this.format("sighash")).substring(0, 10);
        }
        format(t) {
          if ((null == t && (t = "sighash"), "json" === t))
        ...
        static from(t) {
          ...
          if (t instanceof v) {
            const e = k("error", t),
              n = C(t);
            return I(t), new Q(S, e, n);
          }
          return new Q(S, t.name, t.inputs ? t.inputs.map(K.from) : []);
        }
        static isFragment(t) {
          return t && t[B] === U;
        }
      ...
      class z extends H {
        ...
        get topicHash() {
          return (0, o.id)(this.format("sighash"));
        }
        format(t) {
          if ((null == t && (t = "sighash"), "json" === t))
            return JSON.stringify({
        ...
        static getTopicHash(t, e) {
          return (
            (e = (e || []).map((t) => K.from(t))), new z(S, t, e, !1).topicHash
          );
        }
        static from(t) {
          ...
          if (t instanceof v) {
            const e = k("event", t),
              n = C(t, !0),
              r = !!N(t, a(["anonymous"])).has("anonymous");
            return I(t), new z(S, e, n, r);
          }
          return new z(
            S,
            t.name,
            t.inputs ? t.inputs.map((t) => K.from(t, !0)) : [],
            !!t.anonymous,
          );
        }
        static isFragment(t) {
      ...
      class J extends _ {
        ...
        static from(t) {
          ...
          if (t instanceof v) {
            N(t, a(["constructor"]));
            const e = C(t),
              n = !!N(t, a(["payable"])).has("payable"),
              r = T(t);
            return I(t), new J(S, "constructor", e, n, r);
          }
          return new J(
            S,
            "constructor",
            t.inputs ? t.inputs.map(K.from) : [],
            !!t.payable,
      ...
      class Z extends _ {
        ...
        static from(t) {
          ...
          if (t instanceof v) {
            const e = t.toString(),
              n = t.peekKeyword(a(["fallback", "receive"]));
            if (
              ((0, s.en)(n, "type must be fallback or receive", "obj", e),
              "receive" === t.popKeyword(a(["fallback", "receive"])))
            ) {
              const e = C(t);
              return (
                (0, s.en)(
            ...
            return I(t), new Z(S, r, "payable" === i);
          }
          if ("receive" === t.type) return new Z(S, [], !0);
          if ("fallback" === t.type) {
            const e = [K.from("bytes")],
        ...
        static from(t) {
          ...
          if (t instanceof v) {
            const e = k("function", t),
              ...
              r = x(t);
            let s = [];
            N(t, a(["returns"])).has("returns") && (s = C(t));
            const i = T(t);
            return I(t), new q(S, e, r, n, s, i);
          }
          ...
          return (
            ...
            new q(
              ...
              e,
              t.inputs ? t.inputs.map(K.from) : [],
              t.outputs ? t.outputs.map(K.from) : [],
              null != t.gas ? t.gas : null,
            )
          );
        }
      ...
      class W extends H {
        ...
        static from(t) {
          ...
          if (t instanceof v) {
            const e = k("struct", t),
              n = C(t);
            return I(t), new W(S, e, n);
          }
          return new W(S, t.name, t.inputs ? t.inputs.map(K.from) : []);
        }
        static isFragment(t) {
          return t && t[B] === j;
        }
    ...
    2790: (t, e, n) => {
      ...
      class A {
        ...
        decodeErrorResult(t, e) {
          ...
          return (
            (0, o.en)(
              (0, a.QB)(e, 0, 4) === t.selector,
              `data signature does not match error ${t.name}.`,
              "data",
              e,
            ),
            this._decodeParams(t.inputs, (0, a.QB)(e, 4))
          );
        }
        encodeErrorResult(t, e) {
          ...
          return (0, a.zo)([t.selector, this._encodeParams(t.inputs, e || [])]);
        }
        ...
        encodeFunctionResult(t, e) {
          ...
          return (0, a.Dv)(this.#d.encode(t.outputs, e || []));
        }
        ...
        encodeEventLog(t, e) {
          ...
          return (
            ...
            t.inputs.forEach((t, o) => {
              ...
              else i.push(t), a.push(c);
            }),
            { data: this.#d.encode(i, a), topics: n }
          );
        }
        decodeEventLog(t, e, n) {
          ...
          if (null != n && !t.anonymous) {
            const e = t.topicHash;
            (0, o.en)(
              (0, a.A7)(n[0], 32) && n[0].toLowerCase() === e,
          ...
          const c = null != n ? this.#d.decode(r, (0, a.zo)(n)) : null,
        ...
        parseTransaction(t) {
          const e = (0, a.Pw)(t.data, "tx.data"),
            n = (0, c.yT)(null != t.value ? t.value : 0, "tx.value"),
            r = this.getFunction((0, a.Dv)(e.slice(0, 4)));
          if (!r) return null;
        ...
        parseError(t) {
          const e = (0, a.Dv)(t),
            n = this.getError((0, a.QB)(e, 0, 4));
          if (!n) return null;
          const r = this.#d.decode(n.inputs, (0, a.QB)(e, 4));
      ...
      function d(t) {
        ...
        if (t.match(/^XE[0-9]{2}[0-9A-Za-z]{30,31}$/)) {
          ...
          let e = (function (t) {
            t = t.toLowerCase();
            let e = o;
            for (let n = 0; n < t.length; n++) e = e * a + f[t[n]];
            return e;
    ...
    3571: (t, e, n) => {
      ...
      class y {
        ...
        fragment;
        constructor(t, e, n) {
          if (((0, a.h)(this, { fragment: e }), e.inputs.length < n.length))
      ...
      async function b(t, e) {
        const n = (0, o.kK)(r._.dereference(t, "overrides"));
        return (
          (0, c.en)(
      ...
      function E(t) {
        const e = async function (e) {
            ...
            const o = r.receive || (r.fallback && r.fallback.payable);
            return (
              (0, c.en)(
                o || s,
      ...
      async function C(t, e) {
        const { subs: n } = N(t);
        return n.get((await x(t, e)).tag) || null;
      }
      async function T(t, e, n) {
        ...
        const { fragment: s, tag: i, topics: o } = await x(t, n),
          { addr: a, subs: u } = N(t);
        let l = u.get(i);
        if (!l) {
          const e = { address: a || t, topics: o },
            c = (e) => {
              ...
              if (r) {
                const i = r,
                  o = s ? t.interface.decodeEventLog(s, e.data, e.topics) : [];
                R(t, n, o, (r) => new h.Vj(t, r, n, i, e));
      ...
      class S {
        ...
        constructor(t, e, n, r) {
          ...
          const o = s.vU.from(e);
          let u;
          (0, a.h)(this, { target: t, runner: n, interface: o }),
          ...
          return (
            (0, a.h)(this, { filters: y }),
            (0, a.h)(this, {
              fallback: o.receive || o.fallback ? E(this) : null,
            }),
            new Proxy(this, {
              get: (t, e, n) => {
        ...
        async queryFilter(t, e, n) {
          ...
          const { addr: r, addrPromise: s } = N(this),
            i = r || (await s),
            { fragment: a, topics: u } = await x(this, t),
          ...
          return (
            ...
            (await f.getLogs(l)).map((t) => {
              ...
              return e ? new h.KI(t, this.interface, e) : new o.Zb(t, f);
            })
          );
        }
        async on(t, e) {
          const n = await T(this, "on", t);
          return n.listeners.push({ listener: e, once: !1 }), n.start(), this;
        }
        async once(t, e) {
          const n = await T(this, "once", t);
    ...
    434: (t, e, n) => {
      ...
      class c extends r.Mw {
        ...
        async wait(t) {
          ...
          return null == e ? null : new a(this.#w, this.provider, e);
        }
      }
      class u extends i.Z {
        log;
      ...
      class l extends u {
        constructor(t, e, n, r, i) {
          super(t, e, n, new o(i, t.interface, r));
          const a = t.interface.decodeEventLog(
            r,
            this.log.data,
            this.log.topics,
          );
          (0, s.h)(this, { args: a, fragment: r });
        }
        get eventName() {
          return this.fragment.name;
        }
    ...
    1847: (t, e, n) => {
      ...
      n.r(e),
        n.d(e, {
          ...
          Indexed: () => h.Hk,
          InfuraProvider: () => Go,
          InfuraWebSocketProvider: () => Mo,
          Interface: () => h.vU,
          IpcSocketProvider: () => ia,
          JsonRpcApiProvider: () => go,
          JsonRpcProvider: () => yo,
          JsonRpcSigner: () => po,
          LangEn: () => Ia,
          Log: () => Oi.Zb,
          ...
          ParamType: () => u._R,
          PocketProvider: () => sa,
          QuickNodeProvider: () => Ko,
          Result: () => l.x4,
          Signature: () => pe,
          SigningKey: () => yn,
          SocketBlockSubscriber: () => So,
          SocketEventSubscriber: () => Do,
          SocketPendingSubscriber: () => Bo,
          SocketProvider: () => Uo,
          SocketSubscriber: () => Oo,
          StructFragment: () => u.xs,
          Transaction: () => oi,
          ...
          Typed: () => f._,
          TypedDataEncoder: () => fs,
          UnmanagedSubscriber: () => Ki,
          Utf8ErrorFuncs: () => s.te,
          VoidSigner: () => ro,
          Wallet: () => Zc,
          WebSocketProvider: () => Lo,
          WeiPerEther: () => x,
          Wordlist: () => xa,
          WordlistOwl: () => Ca,
          WordlistOwlA: () => qc,
          ...
          decodeBase58: () => pi,
          decodeBase64: () => ps,
          decodeBytes32String: () => a,
          decodeRlp: () => Hs,
          decryptCrowdsaleJson: () => zc,
          decryptKeystoreJson: () => Cc,
      ...
      function E(t, e, n) {
        ...
        return (
          ...
          (0, b.K)((0, i.QB)((0, d.w)((0, i.zo)(["0xff", r, s, o])), 12))
        );
      }
      var P = n(9554);
      ...
      const j = (t, e, n) => new G(t, e).update(n).digest();
      function K(t, e, n, r) {
        const {
          c: s,
          dkLen: i,
          ...
          if ((F.ZP.number(i), F.ZP.number(o), F.ZP.number(a), i < 1))
          ...
          return { c: i, dkLen: o, asyncTick: a, DK: l, PRF: h, PRFSalt: f };
        })(t, e, n, r);
        let u;
      ...
      j.create = (t, e) => new G(t, e);
      class _ extends M.kb {
        constructor(t, e, n, r) {
          super(),
            (this.blockLen = t),
            (this.outputLen = e),
      ...
      class J extends _ {
        ...
        process(t, e) {
          ...
          let { A: n, B: r, C: s, D: i, E: o, F: a, G: c, H: u } = this;
          for (let t = 0; t < 64; t++) {
            const e =
                (u +
                  ((0, M.np)(o, 6) ^ (0, M.np)(o, 11) ^ (0, M.np)(o, 25)) +
                  (((l = o) & a) ^ (~l & c)) +
                  V[t] +
                  z[t]) |
                0,
      ...
      class tt extends _ {
        ...
        get() {
          ...
          return [t, e, n, r, s, i, o, a, c, u, l, h, f, d, p, g];
        }
        set(t, e, n, r, s, i, o, a, c, u, l, h, f, d, p, g) {
          (this.Ah = 0 | t),
            (this.Al = 0 | e),
            (this.Bh = 0 | n),
            (this.Bl = 0 | r),
        ...
        process(t, e) {
          ...
          for (let t = 16; t < 80; t++) {
            const e = 0 | X[t - 15],
              ...
              l = q.ZP.add4H(u, r, a, X[t - 7], X[t - 16]);
            (X[t] = 0 | l), ($[t] = 0 | u);
          }
          let {
            Ah: n,
          ...
          for (let t = 0; t < 80; t++) {
            ...
            (m = 0 | p),
              ...
              (s = 0 | n),
              (i = 0 | r);
            const T = q.ZP.add3L(P, N, C);
            (n = q.ZP.add3H(T, E, k, x)), (r = 0 | T);
          }
          ({ h: n, l: r } = q.ZP.add(0 | this.Ah, 0 | this.Al, 0 | n, 0 | r)),
            ({ h: s, l: i } = q.ZP.add(0 | this.Bh, 0 | this.Bl, 0 | s, 0 | i)),
            ({ h: o, l: a } = q.ZP.add(0 | this.Ch, 0 | this.Cl, 0 | o, 0 | a)),
            ...
            this.set(n, r, s, i, o, a, c, u, l, h, f, d, p, g, m, y);
        }
        roundClean() {
          X.fill(0), $.fill(0);
        }
      ...
      (lt._ = ct),
        ...
        (lt.register = function (t) {
          if (at) throw new Error("computeHmac is locked");
          ut = t;
        }),
        Object.freeze(lt);
        ...
        process(t, e) {
          ...
          for (let t = 0; t < 5; t++) {
            const e = 4 - t,
              ...
              y = wt[t];
            for (let e = 0; e < 16; e++) {
              const r = (vt(n + Et(t, s, o, c) + Pt[p[e]] + f, m[e]) + l) | 0;
              (n = l), (l = c), (c = 0 | vt(o, 10)), (o = s), (s = r);
            }
            for (let t = 0; t < 16; t++) {
              const n = (vt(r + Et(e, i, a, u) + Pt[g[t]] + d, y[t]) + h) | 0;
              (r = h), (h = u), (u = 0 | vt(a, 10)), (a = i), (i = n);
            }
          }
          this.set(
            (this.h1 + o + u) | 0,
      ...
      (It._ = Ct),
        ...
        (It.register = function (t) {
          if (xt) throw new TypeError("ripemd160 is locked");
          Tt = t;
        }),
        Object.freeze(It);
      let Rt = !1;
      ...
      function Bt(t, e, n, r, s) {
        const o = (0, i.Pw)(t, "password"),
          a = (0, i.Pw)(e, "salt");
        return (0, i.Dv)(St(o, a, n, r, s));
      }
      (Bt._ = Ot),
        (Bt.lock = function () {
          Rt = !0;
      ...
      function _t(t, e, n, r, s) {
        const i = K(Z, t, n, { c: 1, dkLen: e });
        return n.fill(0), r.fill(0), s.fill(0), i;
      }
      let Ht = !1,
        Vt = !1;
      const Qt = async function (t, e, n, r, s, i, o) {
          return await (async function (t, e, n) {
            ...
            for (let t = 0; t < i; t++) {
              ...
              await (0, M.oY)(r - 1, d, (t) => {
                ...
                await (0, M.oY)(r, d, (t) => {
                  const n = u[e + a - 16] % r;
                  for (let t = 0; t < a; t++) h[t] = u[e + t] ^ c[n * a + t];
                  jt(h, 0, u, e, s), f();
                });
            }
            return _t(t, o, l, c, h);
          })(t, e, { N: n, r, p: s, dkLen: i, onProgress: o });
        },
        zt = function (t, e, n, r, s, i) {
          return (function (t, e, n) {
            ...
            for (let t = 0; t < i; t++) {
              ...
              for (let t = 0; t < r; t++) {
                const t = u[e + a - 16] % r;
                for (let n = 0; n < a; n++) h[n] = u[e + n] ^ c[t * a + n];
                jt(h, 0, u, e, s), f();
              }
            }
            return _t(t, o, l, c, h);
      ...
      let Jt = Qt,
        Zt = zt;
      async function qt(t, e, n, r, s, o, a) {
        const c = (0, i.Pw)(t, "passwd"),
          u = (0, i.Pw)(e, "salt");
        return (0, i.Dv)(await Jt(c, u, n, r, s, o, a));
      }
      function Wt(t, e, n, r, s, o) {
        const a = (0, i.Pw)(t, "passwd"),
          c = (0, i.Pw)(e, "salt");
        return (0, i.Dv)(Zt(a, c, n, r, s, o));
      }
      (qt._ = Qt),
        (qt.lock = function () {
          Vt = !0;
        ...
        (Wt.register = function (t) {
          if (Ht) throw new Error("scryptSync is locked");
          Zt = t;
        }),
        Object.freeze(Wt);
      const Yt = function (t) {
          return ot("sha256").update(t).digest();
        },
        Xt = function (t) {
          return ot("sha512").update(t).digest();
        };
      let $t = Yt,
        te = Xt,
        ee = !1,
      ...
      class pe {
        ...
        static getNormalizedV(t) {
          ...
          return e === oe || e === ue
            ...
            : e === ae || e === le
            ? 28
            : ((0, A.en)(e >= he, "invalid v", "v", t), e & ae ? 27 : 28);
        }
        static from(t) {
          function e(e, n) {
          ...
          const { networkV: o, v: a } = (function (t, n, r) {
              if (null != t) {
                const e = (0, p.yT)(t);
                return {
      ...
      class Be {
        ...
        multiplyUnsafe(t) {
          ...
          let { k1neg: r, k1: s, k2neg: i, k2: o } = ke.splitScalar(n),
            a = e,
            c = e,
            u = this;
          for (; s > ye || o > ye; )
        ...
        wNAF(t, e) {
          ...
          for (let e = 0; e < o; e++) {
            ...
            const h = n,
              ...
              d = e % 2 != 0,
              p = o < 0;
            0 === o ? (i = i.add(De(d, r[h]))) : (s = s.add(De(p, r[f])));
          }
          return { p: s, f: i };
        }
        multiply(t, e) {
          let n,
            ...
            s = Ye(t);
          if (Re) {
            const { k1neg: t, k1: i, k2neg: o, k2: a } = ke.splitScalar(s);
            let { p: c, f: u } = this.wNAF(i, e),
              { p: l, f: h } = this.wNAF(a, e);
            (c = De(t, c)),
              (l = De(o, l)),
      ...
      class Le {
        ...
        static fromCompressedHex(t) {
          ...
          if (!an(n)) throw new Error("Point is not on curve");
          let r = (function (t) {
            const { P: e } = Ee,
              n = BigInt(6),
              r = BigInt(11),
        ...
        static fromHex(t) {
          ...
          if (n === Te && 4 === r) return this.fromUncompressedHex(e);
          throw new Error(
            `Point.fromHex: received invalid point. Expected 32-${Ce} compressed bytes or ${Te} uncompressed bytes, not ${n}`,
          );
        }
        ...
        assertValidity() {
          const t = "Point is not on elliptic curve",
            { x: e, y: n } = this;
          if (!an(e) || !an(n)) throw new Error(t);
          const r = Xe(n * n);
          if (Xe(r - Ie(e)) !== ye) throw new Error(t);
        }
        equals(t) {
        ...
        multiplyAndAddUnsafe(t, e, n) {
          const r = Be.fromAffine(this),
            ...
            o = s.add(i);
          return o.equals(Be.ZERO) ? void 0 : o.toAffine();
        }
      }
      function Fe(t) {
      ...
      function Me(t) {
        if (t.length < 2 || 2 !== t[0])
          throw new Error(`Invalid signature integer tag: ${_e(t)}`);
        const e = t[1],
          n = t.subarray(2, e + 2);
        if (!e || n.length !== e)
      ...
      class Ge {
        ...
        static fromDER(t) {
          ...
          const { r: n, s: r } = (function (t) {
            if (t.length < 2 || 48 != t[0])
              throw new Error(`Invalid signature tag: ${_e(t)}`);
            if (t[1] !== t.length - 2)
            ...
            if (s.length)
              throw new Error(
                `Invalid signature: left bytes after parsing: ${_e(s)}`,
              );
            return { r: e, s: r };
          })(e ? t : Ze(t));
          return new Ge(n, r);
        ...
        assertValidity() {
          const { r: t, s: e } = this;
          if (!on(t)) throw new Error("Invalid Signature: r must be 0 < r < n");
          if (!on(e)) throw new Error("Invalid Signature: s must be 0 < s < n");
        }
        hasHighS() {
          const t = Ee.n >> we;
          return this.s > t;
      ...
      const Ke = Array.from({ length: 256 }, (t, e) =>
        e.toString(16).padStart(2, "0"),
      );
      function _e(t) {
        if (!(t instanceof Uint8Array)) throw new Error("Expected Uint8Array");
        let e = "";
        for (let n = 0; n < t.length; n++) e += Ke[t[n]];
        return e;
      }
      const He = BigInt(
      ...
      function Ye(t) {
        if ("number" == typeof t && Number.isSafeInteger(t) && t > 0)
          return BigInt(t);
        if ("bigint" == typeof t && on(t)) return t;
        throw new TypeError(
      ...
      function cn(t, e, n, r = !0) {
        ...
        if (!on(i)) return;
        const o = tn(i, s),
          a = Le.BASE.multiply(i),
          c = Xe(a.x, s);
        if (c === ye) return;
        const u = Xe(o * Xe(e + n * c, s), s);
        if (u === ye) return;
        let l = new Ge(c, u),
          h = (a.x === l.r ? 0 : 2) | Number(a.y & we);
        return (
      ...
      function un(t) {
        ...
        if (!on(e)) throw new Error("Expected private key: 0 < key < n");
        return e;
      }
      function ln(t) {
        const e = t instanceof Uint8Array,
      ...
      const pn = {
        ...
        mn = {
          ...
          randomPrivateKey: () => mn.hashToPrivateKey(mn.randomBytes(xe + 8)),
          ...
          sha256: async (...t) => {
            if (pn.web) {
              const e = await pn.web.subtle.digest("SHA-256", je(...t));
        ...
        sign(t) {
          ...
          const [e, n] = (function (t, e, n = {}) {
              const {
                  ...
                  return { seed: je(...i), m: hn(r), d: s };
                })(t, e, n.extraEntropy),
                o = new sn(32, xe);
              let a;
              for (
                o.reseedSync(r);
                !(a = cn(o.generateSync(), s, i, n.canonical));
      ...
      function Yn(t, e) {
        if (t >= Kn && t < Jn && e >= _n && e < Zn)
          return jn + (t - Kn) * Qn + (e - _n) * Vn;
        if (Wn(t) && e > Hn && e < qn && (t - jn) % Vn == 0)
          return t + (e - Hn);
        {
          let n = Gn.get(t);
      ...
      const er = 65039,
        ...
        sr = 45;
      function ir() {
        return new Set(vn(Tn));
      }
      const or = new Map(Pn(Tn)),
        ar = ir(),
        cr = ir(),
        ur = new Set(
          vn(Tn).map(
        ...
        hr = (ir(), En(Tn));
      function fr() {
        return new Set([vn(Tn).map((t) => hr[t]), vn(Tn)].flat(2));
      }
      const dr = Tn(),
        pr = kn((t) => {
          let e = kn(Tn).map((t) => t + 96);
          if (e.length) {
            let n = t >= dr;
            ...
            let r = fr(),
              s = fr(),
              i = [...r, ...s].sort((t, e) => t - e);
            return { N: e, P: r, M: !Tn(), R: n, V: new Set(i) };
          }
        }),
        gr = ir(),
        mr = new Map();
      ...
      function Pr(t, e = On) {
        ...
        for (let r = 0; r < i; r++) {
          let i = t[r];
          Cr(i) && (n.push(Sn(t.slice(s, r))), n.push(e(i)), (s = r + 1));
        }
        return n.push(Sn(t.slice(s, i))), n.join("");
      }
      function kr(t) {
        return (Cr(t) ? "" : `${Nr(Pr([t]))} `) + On(t);
      }
      function Nr(t) {
        return `"${t}"‎`;
      }
                ...
                let e = [...new Set(s)],
                  [i] = (function (t) {
                    ...
                    for (let n of t) {
                      ...
                      if (!t.length) throw e === pr ? Ir(n) : Rr(e[0], n);
      ...
      function _r(t, e) {
        return Kr(yn.recoverPublicKey(t, e));
      }
      function Hr(t) {
        return (
      ...
      const ts = BigInt(-1),
        ...
        as = ["name", "version", "chainId", "verifyingContract", "salt"];
      function cs(t) {
        return function (e) {
          return (
            (0, A.en)(
      ...
      class fs {
        ...
        getEncoder(t) {
          let e = this.#x.get(t);
          return e || ((e = this.#C(t)), this.#x.set(t, e)), e;
        }
        #C(t) {
          {
            const e = ls(t);
        ...
        static hashDomain(t) {
          ...
          return (
            e.sort((t, e) => as.indexOf(t.name) - as.indexOf(e.name)),
        ...
        static getPayload(t, e, n) {
          ...
          as.forEach((e) => {
            const n = t[e];
            null != n && ((r[e] = us[e](n)), s.push({ name: e, type: os[e] }));
          });
          const o = fs.from(e),
            a = Object.assign({}, e);
          return (
      ...
      class xs {
        ...
        constructor(t) {
          (this.#U = String(t)),
            ...
            (this.#B = ""),
            (this.#D = 3e5),
            (this.#H = { slotInterval: 250, maxAttempts: 12 });
        }
        toString() {
        ...
        setThrottleParams(t) {
          null != t.slotInterval && (this.#H.slotInterval = t.slotInterval),
            null != t.maxAttempts && (this.#H.maxAttempts = t.maxAttempts);
        }
        async #V(t, e, n, r, s) {
          if (t >= this.#H.maxAttempts)
            return s.makeServerError("exceeded maximum retry limit");
          (0, A.hu)(Ts() <= e, "timeout", "TIMEOUT", {
          ...
          if (o in Es) {
            const t = await Es[o](i.url, Ns(r.#_));
            if (t instanceof Cs) {
              let e = t;
              if (this.processFunc) {
                Ns(r.#_);
          ...
          const a = await ms(i, Ns(r.#_));
          let c = new Cs(a.statusCode, a.statusMessage, a.headers, a.body, r);
          ...
          if (
            ...
            let s =
              this.#H.slotInterval * Math.trunc(Math.random() * Math.pow(2, t));
            return (
              "string" == typeof n &&
                n.match(/^[1-9][0-9]*$/) &&
                (s = parseInt(n)),
      ...
      class Cs {
        ...
        makeServerError(t, e) {
          ...
          const r = new Cs(599, n, this.headers, this.body, this.#J || void 0);
      ...
      function _s(t, e) {
        ...
        if (t[e] >= 248) {
          ...
          n(e + 1 + r);
          const s = js(t, e + 1, r);
          return n(e + 1 + r + s), Ks(t, e, e + 1 + r, r + s);
        }
        if (t[e] >= 192) {
          const r = t[e] - 192;
          return n(e + 1 + r), Ks(t, e, e + 1, r);
        }
        if (t[e] >= 184) {
          const r = t[e] - 183;
          n(e + 1 + r);
      ...
      class oi {
        ...
        get from() {
          return null == this.signature
            ? null
            : _r(this.unsignedHash, this.signature);
        }
        get fromPublicKey() {
          return null == this.signature
            ? null
      ...
      class Ai {
        ...
        async #ht(t, e) {
          ...
          (await this.supportsWildcard()) &&
            ...
            (e = [jr(this.name), n.encodeFunctionData(r, e)]),
      ...
      async function Hi(t, e) {
        ...
        if ((0, i.A7)(t, 32)) {
          const e = t.toLowerCase();
          return { type: "transaction", tag: ji("tx", { hash: e }), hash: e };
        }
        if (t.orphan) {
          const e = t;
          return {
        ...
        if (t.address || t.topics) {
          ...
          if (n.address) {
            ...
            Array.isArray(n.address) ? n.address.forEach(o) : o(n.address),
              ...
              (r.address = _i(t.map((t) => t.toLowerCase())));
          }
          return { filter: r, tag: ji("event", r), type: "event" };
        }
      ...
      class zi {
        ...
        async #Ot(t, e, n) {
          ...
          try {
            ...
            if (
              ...
              (0, A.hu)(
                a.sender.toLowerCase() === o.toLowerCase(),
              ...
              const c = await this.ccipReadFetch(r, a.calldata, a.urls);
              (0, A.hu)(
                null != c,
              ...
              const u = {
                to: o,
                data: (0, i.zo)([a.selector, Xi([c, a.extraData])]),
              };
              this.emit("debug", {
        ...
        _clearTimeout(t) {
          const e = this.#Tt.get(t);
          e && (e.timer && clearTimeout(e.timer), this.#Tt.delete(t));
        }
        _setTimeout(t, e) {
          null == e && (e = 0);
          const n = this.#Ct++,
          ...
          if (this.paused) this.#Tt.set(n, { timer: null, func: r, time: e });
          else {
            const t = setTimeout(r, e);
            this.#Tt.set(n, { timer: t, func: r, time: Vi() });
          }
          return n;
        }
        ...
        async #Ut(t, e) {
          let n = await Hi(t, this);
          return (
            "event" === n.type &&
              e &&
              e.length > 0 &&
              !0 === e[0].removed &&
              (n = await Hi({ orphan: "drop-log", log: e[0] }, this)),
            this.#bt.get(n.tag) || null
          );
        }
        async #Lt(t) {
          const e = await Hi(t, this),
            n = e.tag;
          let r = this.#bt.get(n);
          return (
            r ||
        ...
        async emit(t, ...e) {
          ...
          return (
            (n.listeners = n.listeners.filter(({ listener: n, once: r }) => {
              const s = new ai.Z(this, r ? null : n, t);
              try {
                n.call(this, ...e, s);
              } catch (t) {}
              return !r;
        ...
        destroy() {
          ...
          for (const t of this.#Tt.keys()) this._clearTimeout(t);
          this.#Et = !0;
        }
        get paused() {
          return null != this.#vt;
      ...
      class no {
        ...
        async getNonce(t) {
          return to(this, "getTransactionCount").getTransactionCount(
            await this.getAddress(),
            t,
          );
        }
        async populateCall(t) {
          return await eo(this, t);
        }
        async populateTransaction(t) {
          const e = to(this, "populateTransaction"),
            n = await eo(this, t);
        ...
        async estimateGas(t) {
          return to(this, "estimateGas").estimateGas(
            await this.populateCall(t),
          );
        }
        async call(t) {
          return to(this, "call").call(await this.populateCall(t));
        }
        async resolveName(t) {
          const e = to(this, "resolveName");
          return await e.resolveName(t);
        }
        async sendTransaction(t) {
          const e = to(this, "sendTransaction"),
      ...
      class so {
        ...
        pause(t) {
          t && this.#Kt(), this.#dt.off("block", this.#pt);
        }
        resume() {
          this.start();
        }
      ...
      class io extends so {
        ...
        constructor(t, e) {
          var n;
          super(t), (this.#_t = ((n = e), JSON.parse(JSON.stringify(n))));
        }
        _recover(t) {
          return new Fi(t, this.#_t);
        }
        async _subscribe(t) {
          return await t.send("eth_newFilter", [this.#_t]);
        }
        async _emitResults(t, e) {
          for (const n of e) t.emit(this.#_t, t._wrapLog(n, t._network));
        }
      }
      class oo extends so {
        async _subscribe(t) {
      ...
      const ao = "bigint,boolean,function,number,string,symbol".split(/,/g);
      function co(t) {
        if (null == t || ao.indexOf(typeof t) >= 0) return t;
      ...
      class go extends zi {
              ...
              return (
                t.filter &&
                  ...
                  (Array.isArray(t.filter.address)
                    ? (t.filter.address = t.filter.address.map(lo))
                    : (t.filter.address = lo(t.filter.address))),
        ...
        async getSigner(t) {
          ...
          t = (0, b.K)(t);
          for (const e of n) if ((0, b.K)(e) === t) return new po(this, t);
      ...
      class mo extends go {
        ...
        _getSubscriber(t) {
          ...
          return ho(e) && (e.pollingInterval = this.#Zt), e;
        }
        get pollingInterval() {
          return this.#Zt;
        }
        set pollingInterval(t) {
          ...
          (this.#Zt = t),
            this._forEachSubscriber((t) => {
              ho(t) && (t.pollingInterval = this.#Zt);
            });
        }
      }
      class yo extends mo {
        ...
        constructor(t, e, n) {
          null == t && (t = "http://localhost:8545"),
            super(e, n),
            (this.#qt = "string" == typeof t ? new xs(t) : t.clone());
        }
        _getConnection() {
      ...
      function Ao(t, e) {
        if (null != t) {
          if (
            ...
            for (const n in t) Ao(t[n], e);
          if ("string" == typeof t)
            try {
              return Ao(JSON.parse(t), e);
            } catch (t) {}
        }
      }
      const bo =
      ...
      class vo extends yo {
        ...
        constructor(t, e) {
          ...
          super(vo.getRequest(n, e), n, r), (0, B.h)(this, { apiKey: e });
        }
        _getProvider(t) {
          try {
            return new vo(t, this.apiKey);
          } catch (t) {}
      ...
      const Eo = "_gg7wSSi0KMBsdKnGVfHDueq6xMB9EkC";
      class Po extends yo {
        apiKey;
        constructor(t, e) {
          null == t && (t = "mainnet");
          const n = Fs.from(t);
          null == e && (e = Eo),
            super(Po.getRequest(n, e), n, { staticNetwork: n }),
            (0, B.h)(this, { apiKey: e });
        }
        _getProvider(t) {
          try {
            return new Po(t, this.apiKey);
          } catch (t) {}
          return super._getProvider(t);
        }
        async _perform(t) {
        ...
        static getRequest(t, e) {
          ...
          return (
            (n.allowGzip = !0),
            e === Eo && (n.retryFunc = async (t, e, n) => (Rs("alchemy"), !0)),
            n
          );
        }
      }
      ...
      const No = "org.ethers.plugins.provider.Etherscan";
      class xo extends Ss {
        baseUrl;
        constructor(t) {
          super(No), (0, B.h)(this, { baseUrl: t });
        }
        clone() {
          return new xo(this.baseUrl);
        }
      }
      const Co = ["enableCcipRead"];
      let To = 1;
      class Io extends zi {
        network;
        apiKey;
          ...
          return "proxy" === t
            ? ("2.0" != u.jsonrpc &&
                ...
                (0, A.hu)(
                  ...
                  "SERVER_ERROR",
                  { request: a, response: c, info: { result: u } },
                )),
              u.error &&
                (this.emit("debug", {
                  action: "receiveError",
        ...
        _checkError(t, e, n) {
          ...
          if (r && "broadcastTransaction" === t.method) {
            const e = oi.from(t.signedTransaction);
        ...
        _getSubscriber(t) {
          switch (t.type) {
            ...
            case "pending":
              return new Bo(this);
            case "event":
              return new Do(this, t.filter);
            case "orphan":
              if ("drop-log" === t.filter.orphan) return new Ki("drop-log");
          }
      ...
      class Lo extends Uo {
        ...
        constructor(t, e) {
          super(e),
            "string" == typeof t
              ? ((this.#qt = () => new Ro(t)), (this.#re = this.#qt()))
              : "function" == typeof t
              ? ((this.#qt = t), (this.#re = t()))
      ...
      const Fo = "84842078b09946638c03157f83405213";
      class Mo extends Lo {
        projectId;
        projectSecret;
        constructor(t, e) {
      ...
      class Go extends yo {
        ...
        constructor(t, e, n) {
          ...
          null == e && (e = Fo),
            null == n && (n = null),
            super(Go.getRequest(r, e, n), r, { staticNetwork: r }),
            (0, B.h)(this, { projectId: e, projectSecret: n });
        }
        _getProvider(t) {
          try {
            return new Go(t, this.projectId, this.projectSecret);
          } catch (t) {}
          return super._getProvider(t);
        }
        isCommunityResource() {
      ...
      const jo = "919b412a057b5e9c9b6dce193c5a60242d6efadb";
      class Ko extends yo {
        token;
        constructor(t, e) {
          null == t && (t = "mainnet");
          const n = Fs.from(t);
          null == e && (e = jo),
            super(Ko.getRequest(n, e), n, { staticNetwork: n }),
            (0, B.h)(this, { token: e });
        }
        _getProvider(t) {
          try {
            return new Ko(t, this.token);
          } catch (t) {}
          return super._getProvider(t);
        }
        isCommunityResource() {
          return this.token === jo;
        }
        static getRequest(t, e) {
          null == e && (e = jo);
          const n = new xs(
      ...
      const zo = { stallTimeout: 400, priority: 1, weight: 1 },
        Jo = {
          blockNumber: -2,
          requests: 0,
          lateResponses: 0,
      ...
      function Zo(t) {
        if (null == t) return "null";
        if (Array.isArray(t)) return "[" + t.map(Zo).join(",") + "]";
        ...
        switch (typeof t) {
          ...
          case "object": {
            ...
            return (
              e.sort(),
              "{" +
                e.map((e) => `${JSON.stringify(e)}:${Zo(t[e])}`).join(",") +
                "}"
            );
          }
        }
      ...
      function Yo(t, e) {
        ...
        let s = null;
        const i = [];
        for (const { value: t, tag: o, weight: a } of e)
          if (t instanceof Error) {
            const e = r.get(o) || { value: t, weight: 0 };
            (e.weight += a),
              r.set(o, e),
              (null == s || e.weight > s.weight) && (s = e);
          } else i.push(BigInt(t)), (n += a);
        if (n < t) return s && s.weight >= t ? s.value : void 0;
        i.sort((t, e) => (t < e ? -1 : e > t ? 1 : 0));
        const o = Math.floor(i.length / 2);
        return i.length % 2 ? i[o] : (i[o - 1] + i[o] + _o) / Ho;
      }
      function Xo(t, e) {
        const n = Wo(t, e);
      ...
      class $o extends zi {
        ...
        constructor(t, e) {
          super(e),
            (this.#se = t.map((t) =>
              t instanceof zi
                ? Object.assign({ provider: t }, zo, Jo)
                : Object.assign({}, zo, t, Jo),
            )),
            (this.#ie = -2),
            (this.#oe = null),
            (this.quorum = 2),
        ...
        async #le(t, e) {
          ...
          for (const e of t)
            if (null != e.result) {
              const { tag: t, value: r } = qo(e.result);
            ...
            switch (e.method) {
              case "getBlockNumber": {
                ...
                const t = (function (t, e) {
                  if (1 === t) return (0, p.Dx)(Yo(t, e), "%internal");
                  const n = new Map(),
                    r = (t, e) => {
              ...
              case "getTransactionReceipt":
              case "getLogs":
                return Wo(this.quorum, n);
              case "broadcastTransaction":
                return Xo(this.quorum, n);
            }
            (0, A.hu)(!1, "unsupported method", "UNSUPPORTED_OPERATION", {
              operation: `_perform(${Qo(e.method)})`,
            });
          }
        }
        async #he(t, e) {
          ...
          return (
            (0, A.hu)(n.length > 0, "quorum not met", "SERVER_ERROR", {
              ...
              info: {
                request: e,
                results: Array.from(t).map((t) => Qo(t.result)),
              },
            }),
          ...
          if ("broadcastTransaction" === t.method) {
            const e = await Promise.all(
                this.#se.map(async ({ provider: e, weight: n }) => {
                  try {
                    ...
                    return Object.assign(qo({ result: r }), { weight: n });
                  } catch (t) {
                    return Object.assign(qo({ error: t }), { weight: n });
                  }
                }),
              ),
              n = Xo(this.quorum, e);
            if (
              ((0, A.hu)(
                ...
                {
                  request: "%sub-requests",
                  info: { request: t, results: e.map(Qo) },
                },
              ),
              n instanceof Error)
            )
      ...
      function ta(t, e) {
        ...
        if ("-" !== e.alchemy)
          try {
            r.push(new Po(t, e.alchemy));
          } catch (t) {}
        if ("-" !== e.ankr && null != e.ankr)
          try {
            r.push(new vo(t, e.ankr));
          } catch (t) {}
        if ("-" !== e.cloudflare)
          try {
            r.push(new ko(t));
      ...
      class ea extends no {
        ...
        connect(t) {
          return new ea(this.signer.connect(t));
        }
        async getNonce(t) {
          if ("pending" === t) {
      ...
      const ra = "62e1ad51b37b8e00394bda3b";
      class sa extends yo {
        applicationId;
        applicationSecret;
        constructor(t, e, n) {
          null == t && (t = "mainnet");
          const r = Fs.from(t);
          null == e && (e = ra), null == n && (n = null);
          const s = { staticNetwork: r };
          super(sa.getRequest(r, e, n), r, s),
            (0, B.h)(this, { applicationId: e, applicationSecret: n });
        }
        _getProvider(t) {
          try {
            return new sa(t, this.applicationId, this.applicationSecret);
          } catch (t) {}
          return super._getProvider(t);
        }
        static getRequest(t, e, n) {
      ...
      class ga {
        ...
        _value;
        constructor(t, e, n) {
          (0, A.NK)(t, la, "FixedNumber"), (this.#ge = e), (this.#pe = n);
        ...
        #we(t, e) {
          return (t = da(t, this.#pe, e)), new ga(la, t, this.#pe);
        }
        #Ae(t, e) {
        ...
        #Ee(t, e) {
          return (
            (0, A.hu)(t.#ge !== aa, "division by zero", "NUMERIC_FAULT", {
              operation: "div",
        ...
        round(t) {
          ...
          const s = fa(e);
          return (
            (r = (r / s) * s), da(r, this.#pe, "round"), new ga(la, r, this.#pe)
          );
        }
        isZero() {
          return this.#ge === aa;
        ...
        toFormat(t) {
          return ga.fromString(this.toString(), t);
        }
        static fromValue(t, e, n) {
          ...
          return da(i, s, "fromValue"), new ga(la, i, s);
        }
        static fromString(t, e) {
          ...
          return da(o, r, "fromString"), new ga(la, o, r);
        }
      ...
      const ma = ["wei", "kwei", "mwei", "gwei", "szabo", "finney", "ether"];
      function ya(t, e) {
        let n = 18;
        if ("string" == typeof e) {
        ...
        return ga.fromValue(t, n, { decimals: n, width: 512 }).toString();
      }
      function wa(t, e) {
        ...
        return ga.fromString(t, { decimals: n, width: 512 }).value;
      }
      function Aa(t) {
        return ya(t, 18);
      }
      ...
      function Na(t) {
        return (
          ...
          (function (t, e) {
            for (let n = Ea.length - 1; n >= 0; n--)
              t = t.split(Ea[n]).join(e.substring(2 * n, 2 * n + 2));
            const n = [],
            ...
            return ka(ka(n, ";"), ":");
          })(t.substring(1 + 2 * Ea.length), t.substring(1, 1 + 2 * Ea.length))
        );
      }
      class xa {
        locale;
      ...
      function Oa(t, e) {
        (0, A.fA)("NFKD"), null == e && (e = Ia.wordlist());
        const n = e.split(t);
        (0, A.en)(
        ...
        const o = (32 * n.length) / 3,
          a = Ra(n.length / 3),
          c = (0, i.Pw)(re(r.slice(0, o / 8)))[0] & a;
        return (
          (0, A.en)(
            c === (r[r.length - 1] & a),
        ...
        for (let e = 0; e < t.length; e++)
          r > 8
            ...
            : ((n[n.length - 1] <<= r),
              ...
              (r += 3));
        const s = t.length / 4,
          i = parseInt(re(t).substring(2, 4), 16) & Ra(s);
        return (
          (n[n.length - 1] <<= s),
          (n[n.length - 1] |= i >> (8 - s)),
      ...
      class Da {
        ...
        constructor(t, e, n, r, s) {
          null == r && (r = ""),
            null == s && (s = Ia.wordlist()),
            (0, A.NK)(t, Ba, "Mnemonic"),
        ...
        static fromPhrase(t, e, n) {
          const r = Oa(t, n);
          return (t = Sa((0, i.Pw)(r), n)), new Da(Ba, r, t, e, n);
        }
        static fromEntropy(t, e, n) {
          const r = (0, i.Pw)(t, "entropy"),
            s = Sa(r, n);
          return new Da(Ba, (0, i.Dv)(r), s, e, n);
        }
        static entropyToPhrase(t, e) {
          return Sa((0, i.Pw)(t, "entropy"), e);
        }
      ...
      class Ua extends no {
        ...
        constructor(t, e) {
          super(e),
            ...
            (this.#xe = t);
          const n = Kr(this.signingKey.publicKey);
        ...
        signMessageSync(t) {
          return this.signingKey.sign(Hr(t)).serialized;
        }
        async signTypedData(t, e, n) {
      ...
      class sc {
        ...
        constructor(t) {
          ...
          ja(this, La, new Uint8Array(t), "f");
          const e = Ka[this.key.length];
          if (null == e)
            throw new TypeError(
              "invalid key size (must be 16, 24 or 32 bytes)",
            );
          ja(this, Ma, [], "f"), ja(this, Fa, [], "f");
          for (let t = 0; t <= e; t++)
            Ga(this, Ma, "f").push([0, 0, 0, 0]),
              Ga(this, Fa, "f").push([0, 0, 0, 0]);
          const n = 4 * (e + 1),
            r = this.key.length / 4,
            s = rc(this.key);
          let i;
          for (let t = 0; t < r; t++)
            (i = t >> 2),
              (Ga(this, Ma, "f")[i][t % 4] = s[t]),
              (Ga(this, Fa, "f")[e - i][t % 4] = s[t]);
          let o,
            a = 0,
            c = r;
          for (; c < n; ) {
            ...
            for (; u < r && c < n; )
              (t = c >> 2),
                (i = c % 4),
                (Ga(this, Ma, "f")[t][i] = s[u]),
                (Ga(this, Fa, "f")[e - t][i] = s[u++]),
                c++;
          }
          for (let t = 1; t < e; t++)
            for (let e = 0; e < 4; e++)
        ...
        encrypt(t) {
          ...
          const e = Ga(this, Ma, "f").length - 1,
            n = [0, 0, 0, 0];
          let r = rc(t);
          for (let t = 0; t < 4; t++) r[t] ^= Ga(this, Ma, "f")[0][t];
          for (let t = 1; t < e; t++) {
            for (let e = 0; e < 4; e++)
              n[e] =
                Qa[(r[e] >> 24) & 255] ^
          ...
          for (let t = 0; t < 4; t++)
            (i = Ga(this, Ma, "f")[e][t]),
              (s[4 * t] = 255 & (Ha[(r[t] >> 24) & 255] ^ (i >> 24))),
              (s[4 * t + 1] =
                255 & (Ha[(r[(t + 1) % 4] >> 16) & 255] ^ (i >> 16))),
              (s[4 * t + 2] =
                255 & (Ha[(r[(t + 2) % 4] >> 8) & 255] ^ (i >> 8))),
              (s[4 * t + 3] = 255 & (Ha[255 & r[(t + 3) % 4]] ^ i));
          return s;
        }
        decrypt(t) {
          if (16 != t.length)
            throw new TypeError("invalid ciphertext size (must be 16 bytes)");
          const e = Ga(this, Fa, "f").length - 1,
            n = [0, 0, 0, 0];
          let r = rc(t);
          for (let t = 0; t < 4; t++) r[t] ^= Ga(this, Fa, "f")[0][t];
          for (let t = 1; t < e; t++) {
            for (let e = 0; e < 4; e++)
              n[e] =
                qa[(r[e] >> 24) & 255] ^
          ...
          for (let t = 0; t < 4; t++)
            (i = Ga(this, Fa, "f")[e][t]),
              (s[4 * t] = 255 & (Va[(r[t] >> 24) & 255] ^ (i >> 24))),
              (s[4 * t + 1] =
                255 & (Va[(r[(t + 3) % 4] >> 16) & 255] ^ (i >> 16))),
              (s[4 * t + 2] =
                255 & (Va[(r[(t + 2) % 4] >> 8) & 255] ^ (i >> 8))),
              (s[4 * t + 3] = 255 & (Va[255 & r[(t + 1) % 4]] ^ i));
          return s;
        }
      }
      (La = new WeakMap()), (Fa = new WeakMap()), (Ma = new WeakMap());
      class ic {
        constructor(t, e, n) {
      ...
      class lc extends ic {
        constructor(t, e) {
          if (
            (super("ECC", t, lc), oc.set(this, void 0), ac.set(this, void 0), e)
          ) {
            if (e.length % 16)
              throw new TypeError("invalid iv size (must be 16 bytes)");
            cc(this, oc, new Uint8Array(e), "f");
          } else cc(this, oc, new Uint8Array(16), "f");
          cc(this, ac, this.iv, "f");
        }
        get iv() {
          return new Uint8Array(uc(this, oc, "f"));
        }
        encrypt(t) {
          if (t.length % 16)
            throw new TypeError(
          ...
          for (let n = 0; n < t.length; n += 16) {
            for (let e = 0; e < 16; e++) uc(this, ac, "f")[e] ^= t[n + e];
            cc(this, ac, this.aes.encrypt(uc(this, ac, "f")), "f"),
              e.set(uc(this, ac, "f"), n);
          }
          return e;
        }
        decrypt(t) {
          ...
          for (let n = 0; n < t.length; n += 16) {
            ...
            for (let s = 0; s < 16; s++)
              (e[n + s] = r[s] ^ uc(this, ac, "f")[s]),
                (uc(this, ac, "f")[s] = t[n + s]);
          }
          return e;
        }
      }
      (oc = new WeakMap()), (ac = new WeakMap());
      ...
      function bc(t, e) {
        ...
        if (
          ((0, A.en)(!i || null != o, "missing required value", "path", r),
          s && null != o)
        ) {
          if ("int" === s) {
            if ("string" == typeof o && o.match(/^-?[0-9]+$/))
              return parseInt(o);
            if (Number.isSafeInteger(o)) return o;
          }
          if ("number" === s && "string" == typeof o && o.match(/^-?[0-9.]*$/))
            return parseFloat(o);
          if ("data" === s && "string" == typeof o) return yc(o);
      ...
      function Pc(t, e) {
        ...
        const c = { address: a, privateKey: o };
        if ("0.1" === bc(t, "x-ethers.version:string")) {
          ...
          c.mnemonic = {
            ...
            entropy: (0, i.Dv)((0, i.Pw)(o.decrypt(r))),
          };
        }
        return c;
      }
      function kc(t) {
        ...
        if (e && "string" == typeof e) {
          if ("scrypt" === e.toLowerCase()) {
            ...
            const o = bc(t, "crypto.kdfparams.dklen:int!");
            return (
              (0, A.en)(32 === o, "invalid kdf.dklen", "kdf.dflen", o),
      ...
      function Nc(t, e) {
        ...
        if ("pbkdf2" === s.name) {
          ...
          return Pc(n, Bt(r, t, e, i, o));
        }
        (0, A.hu)("scrypt" === s.name, "cannot be reached", "UNKNOWN_ERROR", {
          params: s,
        });
        const { salt: i, N: o, r: a, p: c, dkLen: u } = s;
        return Pc(n, Wt(r, i, o, a, c, u));
      }
      function xc(t) {
        return new Promise((e) => {
          setTimeout(() => {
      ...
      async function Cc(t, e, n) {
        ...
        if ("pbkdf2" === i.name) {
          n && (n(0), await xc(0));
          const { salt: t, count: e, dkLen: o, algorithm: a } = i,
            c = Bt(s, t, e, o, a);
          return n && (n(1), await xc(0)), Pc(r, c);
        }
        (0, A.hu)("scrypt" === i.name, "cannot be reached", "UNKNOWN_ERROR", {
          params: i,
        });
        const { salt: o, N: a, r: c, p: u, dkLen: l } = i;
        return Pc(r, await qt(s, o, a, c, u, l, n));
      }
      function Tc(t) {
      ...
      function Ic(t, e, n, s) {
        const o = (0, i.Pw)(n.privateKey, "privateKey"),
          a = null != s.iv ? (0, i.Pw)(s.iv, "options.iv") : Ft(16);
        (0, A.en)(
          16 === a.length,
        ...
        const u = t.slice(0, 16),
          ...
          g = {
            ...
            Crypto: {
              cipher: "aes-128-ctr",
              cipherparams: { iv: (0, i.Dv)(a).substring(2) },
        ...
        if (n.mnemonic) {
          const e = null != s.client ? s.client : `ethers/${r.i}`,
            o = n.mnemonic.path || vc,
            a = n.mnemonic.locale || "en",
            c = t.slice(32, 64),
      ...
      function Rc(t, e, n) {
        ...
        const r = Ac(e),
          s = Tc(n),
          o = Wt(r, s.salt, s.N, s.r, s.p, 64);
        return Ic((0, i.Pw)(o), s, t, n);
      }
      async function Oc(t, e, n) {
        null == n && (n = {});
        const r = Ac(e),
          s = Tc(n),
          o = await qt(r, s.salt, s.N, s.r, s.p, 64, n.progressCallback);
        return Ic((0, i.Pw)(o), s, t, n);
      }
      ...
      class Kc extends Ua {
        ...
        index;
        depth;
        constructor(t, e, n, r, s, o, a, c, u) {
          super(e, u),
            (0, A.NK)(t, Mc, "HDNodeWallet"),
            (0, B.h)(this, { publicKey: e.compressedPublicKey });
          const l = (0, i.QB)(It(re(this.publicKey)), 0, 4);
          (0, B.h)(this, {
            parentFingerprint: n,
            fingerprint: l,
            chainCode: r,
        ...
        async encrypt(t, e) {
          return await Oc(this.#Ce(), t, { progressCallback: e });
        }
        encryptSync(t) {
          return Rc(this.#Ce(), t);
        }
        ...
        static fromExtendedKey(t) {
          ...
          const n = e[4],
            ...
            o = (0, i.Dv)(e.slice(13, 45)),
            a = e.slice(45, 78);
          switch ((0, i.Dv)(e.slice(0, 4))) {
            case "0x0488b21e":
            case "0x043587cf": {
              const t = (0, i.Dv)(a);
              return new _c(Mc, Kr(t), t, r, o, null, s, n, null);
            }
            case "0x0488ade4":
            case "0x04358394 ":
              if (0 !== a[0]) break;
        ...
        static createRandom(t, e, n) {
          null == t && (t = ""),
            null == e && (e = Sc),
            null == n && (n = Ia.wordlist());
          const r = Da.fromEntropy(Ft(16), t, n);
          return Kc.#Te(r.computeSeed(), r).derivePath(e);
        }
        static fromMnemonic(t, e) {
          return e || (e = Sc), Kc.#Te(t.computeSeed(), t).derivePath(e);
        }
        static fromPhrase(t, e, n, r) {
          null == e && (e = ""),
            null == n && (n = Sc),
            null == r && (r = Ia.wordlist());
          const s = Da.fromPhrase(t, e, r);
          return Kc.#Te(s.computeSeed(), s).derivePath(n);
        }
        static fromSeed(t) {
          return Kc.#Te(t, null);
        }
      ...
      class _c extends ro {
        ...
        deriveChild(t) {
          ...
          const { IR: r, IL: s } = Gc(e, this.chainCode, this.publicKey, null),
            o = yn.addPoints(s, this.publicKey, !0),
            a = Kr(o);
          return new _c(
            Mc,
            a,
      ...
      function zc(t, e) {
        const n = JSON.parse(t),
          ...
          o = yc(bc(n, "encseed:string!"));
        (0, A.en)(o && o.length % 16 == 0, "invalid encseed", "json", t);
        const a = (0, i.Pw)(Bt(r, r, 2e3, 32, "sha256")).slice(0, 16),
          c = o.slice(0, 16),
          u = o.slice(16),
          l = new lc(a, c),
          h = (function (t) {
      ...
      class Zc extends Ua {
        ...
        static #Ie(t) {
          if (
            ...
            const e = Da.fromEntropy(t.mnemonic.entropy),
              n = Kc.fromMnemonic(e, t.mnemonic.path);
        ...
        static createRandom(t) {
          const e = Kc.createRandom();
          return t ? e.connect(t) : e;
        }
        static fromPhrase(t, e) {
          const n = Kc.fromPhrase(t);
            ...
            return (
              e.split(/,/g).forEach((t) => {
                ...
                n = n.replace(
                  ...
                  (t, e) => (
                    0 == --i[s] &&
                      ((e = String.fromCharCode(e.charCodeAt(0), o)), s++),
                    e
                  ),
                );
              }),
    ...
    4101: (t, e, n) => {
      ...
      function f(t) {
        ...
        return (
          t.accessList && (e.accessList = (0, a.z)(t.accessList)),
      ...
      class d {
        ...
        getPrefetchedTransaction(t) {
          ...
          (0, o.en)(!1, "no matching transaction", "indexOrHash", t);
        }
        isMined() {
          return !!this.hash;
        }
      ...
      class p {
        ...
        async getBlock() {
          ...
          return (
            (0, o.hu)(!!t, "failed to find transaction", "UNKNOWN_ERROR", {}), t
          );
        }
        async getTransaction() {
        ...
        async wait(t, e) {
          ...
          const l = async () => {
              ...
              if (!s || null == s.blockNumber)
                for (
                  -1 === a && ((a = i - 3), a < this.#Be && (a = this.#Be));
                  a <= t;

                ) {
                  if (u) return null;
                  const e = await this.provider.getBlock(a, !0);
                  if (null == e) return;
          ...
          const f = new Promise((t, e) => {
            ...
            if (
              ...
              const t = setTimeout(() => {
                a(), e((0, o.wf)("wait for transaction timeout", "TIMEOUT"));
              }, s);
              r.push(() => {
                clearTimeout(t);
              });
            ...
            if (
              ...
              const t = async () => {
                try {
                  ...
                  if ((0, o.VZ)(t, "TRANSACTION_REPLACED"))
                    return a(), void e(t);
                }
    ...
    455: (t, e, n) => {
      ...
      function g(t, e, n) {
        ...
        return o.fill(0), n ? o.set(s, e - s.length) : o.set(s, 0), l(o);
      }
      function m(t, e) {
        return g(t, e, !0);
      }
    ...
    6024: (t, e, n) => {
      ...
      function c(t, e, n) {
        ...
        return (0, s.h)(o, { code: e }), n && Object.assign(o, n), o;
      }
      function u(t, e, n, r) {
        if (!t) throw c(e, n, r);
      }
    ...
    2229: (t, e, n) => {
      ...
      function u(t, e) {
        ...
        return n < i
          ? ((n = -n),
            (0, s.hu)(n <= a, "too low", "NUMERIC_FAULT", {
              operation: "toTwos",
              fault: "overflow",
              value: t,
            }),
            (~n & ((o << r) - o)) + o)
          : ((0, s.hu)(n < a, "too high", "NUMERIC_FAULT", {
              operation: "toTwos",
              fault: "overflow",
              value: t,
            }),
        ...
        switch (typeof t) {
          ...
          case "number":
            return (
              ...
              (0, s.en)(t >= -a && t <= a, "overflow", e || "value", t),
              BigInt(t)
            );
          case "string":
            try {
